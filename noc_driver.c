...
int main(int argc, char *argv[]) {
    ...
    fptr = fopen ("noc_input1.txt","r");
    if (fptr == NULL) {
        printf(" ERROR: Could not open the input file\n");
        return -1; 
    } 
    
    // TODO: Take frequncies from input file later
    // All frequencies normalized wrt default test freq
    double freq[3] = {0.5, 1.0, 2.0};
    ...
    srand(time(0));
    particle_swarm_optimization(noc_nodes, num_cores, M_rows, freq, 3/*num_freq*/, io_pairs, num_io_pairs);
